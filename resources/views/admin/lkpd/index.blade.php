...
@section('header', 'LKPD Siap Pakai')
...
<style>
    ...
    /* LKPD Document Styling - Elegant & Print Ready (Matched to RPP) */
    #resultContent {
    ...
    #resultContent tbody tr:hover {
        background-color: #f1f5f9;
    }

    #resultContent tbody tr:last-child td {
        border-bottom: none;
    }
...
<div class="max-w-5xl mx-auto space-y-10">
    ...
    <div class="bg-white rounded-[2rem] p-8 lg:p-10 shadow-xl shadow-slate-200/60 border border-slate-100">
        ...
        <form id="lkpdForm" class="space-y-6">
            @csrf
    ...
    <div id="resultSection" class="space-y-6">
        ...
        <div id="loadingResult" class="hidden bg-white rounded-[2rem] border border-slate-100 shadow-xl shadow-slate-200/60 p-12 text-center min-h-[300px] flex flex-col items-center justify-center">
            ...
            <h4 class="text-xl font-bold text-slate-600 mb-2">Sedang Menyusun LKPD...</h4>
            <p class="text-slate-400 max-w-sm">Mohon tunggu, AI sedang merancang lembar kerja yang menarik untuk siswa Anda.</p>
        </div>
...
<script>
                ...
                success: function(response) {
                    if(response.result) {
                        ...
                        Swal.fire({
                            icon: 'success',
                            title: 'Berhasil!',
                            text: 'LKPD telah berhasil dibuat.',
    ...
    function downloadWord() {
        ...
        link.download = 'LKPD-Generator.docx';
        link.click();
