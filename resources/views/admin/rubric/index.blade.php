...
@section('header', 'Generator Rubrik Penilaian')
...
<div class="max-w-5xl mx-auto space-y-10">
    ...
    <div class="bg-white rounded-[2rem] p-8 lg:p-10 shadow-xl shadow-slate-200/60 border border-slate-100">
        ...
        <form id="rubricForm" class="space-y-6">
            ...
            <div class="space-y-2">
                ...
                <textarea name="instruksi_khusus" id="instruksi_khusus" rows="3" class="w-full bg-slate-50 border border-slate-300 rounded-xl px-4 py-3 focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all font-medium text-slate-700 placeholder:text-slate-400" placeholder="Contoh: gunakan skala 1-4, tekankan pada proses bukan hasil akhir, dll"></textarea>
            </div>
    ...
    <div id="resultSection" class="space-y-6">
        <div class="flex items-center gap-4">
            ...
            <h3 class="text-lg font-bold text-slate-400 uppercase tracking-widest">Hasil Rubrik Penilaian</h3>
            <div class="h-[1px] flex-1 bg-slate-200"></div>
        </div>
        ...
        <div id="loadingResult" class="hidden bg-white rounded-[2rem] border border-slate-100 shadow-xl shadow-slate-200/60 p-12 text-center min-h-[300px] flex flex-col items-center justify-center">
            ...
            <h4 class="text-xl font-bold text-slate-600 mb-2">Sedang Menyusun Kriteria...</h4>
            <p class="text-slate-400 max-w-sm">AI sedang membuat indikator penilaian yang detail sesuai permintaan Anda.</p>
        </div>
...
<script>
    $(document).ready(function() {
        ...
        $('#rubricForm').on('submit', function(e) {
            ...
            // Scroll to loading - Consistent with others
            $('html, body').animate({
            ...
            $.ajax({
                url: "{{ route('admin.rubric.generate') }}",
                method: 'POST',
                data: formData,
                success: function(response) {
                    if(response.result) {
                        ...
                        Swal.fire({
                            icon: 'success',
                            title: 'Berhasil!',
                            text: 'Rubrik penilaian berhasil dibuat.',
    ...
    function downloadWord() {
        ...
        link.download = 'Rubrik-Penilaian.docx';
        link.click();
