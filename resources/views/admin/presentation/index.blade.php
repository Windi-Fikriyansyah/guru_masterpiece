...
@section('header', 'Generator Kerangka Presentasi')
...
<div class="max-w-5xl mx-auto space-y-10">
        ...
        <form id="presentationForm" class="space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="space-y-2">
                 ...
                 <!-- Jumlah Slide -->
                 <div class="space-y-2">
                    <label for="jumlah_slide" class="block text-sm font-bold text-slate-700 ml-1">Target Jumlah Slide</label>
                    <input type="number" name="jumlah_slide" id="jumlah_slide" class="w-full bg-slate-50 border border-slate-300 rounded-xl px-4 py-3 focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all font-medium text-slate-700 placeholder:text-slate-400" placeholder="Contoh: 10" min="3" max="20" required>
                </div>
            </div>
    ...
    <div id="resultSection" class="space-y-6">
        <div class="flex items-center gap-4">
            ...
            <h3 class="text-lg font-bold text-slate-400 uppercase tracking-widest">Hasil Kerangka Presentasi</h3>
            <div class="h-[1px] flex-1 bg-slate-200"></div>
        </div>
        ...
        <div id="loadingResult" class="hidden bg-white rounded-[2rem] border border-slate-100 shadow-xl shadow-slate-200/60 p-12 text-center min-h-[300px] flex flex-col items-center justify-center">
            ...
            <h4 class="text-xl font-bold text-slate-600 mb-2">Sedang Merancang Slide...</h4>
            <p class="text-slate-400 max-w-sm">AI sedang menyusun alur cerita dan poin-poin presentasi yang menarik.</p>
        </div>
...
<script>
    $(document).ready(function() {
        ...
        $('#presentationForm').on('submit', function(e) {
            ...
            $.ajax({
                url: "{{ route('admin.presentation.generate') }}",
                method: 'POST',
                data: formData,
                success: function(response) {
                    if(response.result) {
                        ...
                        Swal.fire({
                            icon: 'success',
                            title: 'Berhasil!',
                            text: 'Kerangka presentasi berhasil dibuat.',
    ...
    function downloadPDF() {
        ...
        const opt = {
            margin: [15, 15, 15, 15],
            filename: 'Kerangka-Presentasi.pdf',
    ...
    function downloadWord() {
        ...
        link.download = 'Kerangka-Presentasi.docx';
        link.click();
