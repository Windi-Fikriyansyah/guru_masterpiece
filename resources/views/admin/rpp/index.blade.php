...
<div class="max-w-4xl mx-auto">
    ...
    <div class="mb-10 text-center">
        <h2 class="text-3xl font-extrabold text-slate-800 mb-2">Buat RPP Otomatis</h2>
        ...
        <div class="p-8 lg:p-12">
            <form id="rppForm" class="space-y-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    <!-- Tujuan Pembelajaran -->
                    <div class="space-y-2 md:col-span-2">
                        <label for="tujuan" class="text-sm font-bold text-slate-700 ml-1">Tujuan Pembelajaran</label>
                        <textarea id="tujuan" name="tujuan" rows="3" placeholder="Apa yang ingin dicapai setelah pembelajaran ini?" class="w-full bg-slate-50 border-none rounded-2xl px-5 py-4 focus:ring-2 focus:ring-primary/20 transition-all font-medium text-slate-600 placeholder:text-slate-400 resize-none" required></textarea>
                    </div>

                    <!-- Instruksi Khusus -->
                    <div class="space-y-2 md:col-span-2">
                        <label for="instruksi" class="text-sm font-bold text-slate-700 ml-1">Instruksi/Keinginan Khusus</label>
                        <textarea id="instruksi" name="instruksi" rows="3" placeholder="Sebutkan keinginan khusus lainnya (misal: fokus pada aktivitas outdoor)" class="w-full bg-slate-50 border-none rounded-2xl px-5 py-4 focus:ring-2 focus:ring-primary/20 transition-all font-medium text-slate-600 placeholder:text-slate-400 resize-none"></textarea>
                    </div>
                </div>

                <div class="pt-4">
                    <button type="submit" id="generateBtn" class="w-full bg-gradient-to-r from-primary to-secondary text-white font-bold py-5 rounded-2xl shadow-lg shadow-primary/20 hover:shadow-xl hover:shadow-primary/30 transform hover:-translate-y-0.5 transition-all duration-200 flex items-center justify-center gap-3">
    ...
    <div id="resultSection" class="space-y-6">
        ...
        <div id="placeholderResult" class="bg-white rounded-[2.5rem] border-2 border-dashed border-slate-200 p-12 text-center min-h-[300px] flex flex-col items-center justify-center">
            ...
            <p class="text-slate-400 max-w-sm">Isi formulir di atas dan klik tombol generate untuk mulai membuat RPP/Modul Ajar Anda.</p>
        </div>

        <!-- Loading State -->
        <div id="loadingResult" class="hidden bg-white rounded-[2.5rem] border border-slate-100 shadow-xl shadow-slate-200/60 p-12 text-center min-h-[300px] flex flex-col items-center justify-center">
        ...
        <div id="rppActions" class="hidden flex flex-wrap gap-3 mb-4 justify-end">
            <button id="downloadPdfBtn" class="flex items-center gap-2 px-5 py-2.5 bg-red-500 hover:bg-red-600 text-white font-semibold rounded-xl transition-all">
                <i data-lucide="file-down" class="w-5 h-5"></i>
                <span>Unduh PDF</span>
            </button>
            <button id="downloadWordBtn" class="flex items-center gap-2 px-5 py-2.5 bg-blue-500 hover:bg-blue-600 text-white font-semibold rounded-xl transition-all">
                <i data-lucide="file-text" class="w-5 h-5"></i>
                <span>Unduh Word</span>
            </button>
            <button id="copyBtn" class="flex items-center gap-2 px-5 py-2.5 bg-slate-600 hover:bg-slate-700 text-white font-semibold rounded-xl transition-all">
                <i data-lucide="copy" class="w-5 h-5"></i>
                <span>Salin Teks</span>
            </button>
        </div>

        <div id="rppOutput" class="bg-white rounded-[2.5rem] shadow-xl shadow-slate-200/60 border border-slate-100 p-8 lg:p-12 hidden">
